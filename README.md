...
This project is intentionally positioned as more than an HR tool. It demonstrates how I think about enterprise AI adoption as a Chief AI Officer / Solution Architect candidate:
...
- Corporate AI operating model: clear separation between user interface, context handling, scoring logic, QA checks, and final human judgment.
- Agentic engineering roadmap: future-ready patterns for subagents, grader agents, governed memory, reusable skills, advisor models, and scheduled routines.

Project links:

- [Architecture README](https://github.com/TengKianBoon/TengKianBoon/blob/main/candidate-fit-showcase/README.md)
- [Standalone app source](https://github.com/TengKianBoon/TengKianBoon/blob/main/candidate-fit-showcase/index.html)

## What I use GitHub for

- AI-enabled due diligence workflows for climate finance and infrastructure
- RAG / document-intelligence prototypes for evidence review
...
- Singapore-Indonesia carbon-market intelligence notes
